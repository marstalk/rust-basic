...
mod tests{
    ...
    fn test_destruct_tuple(){
        assert_eq!(destruct_tuple((5, 2, String::from("hello"), 4)), "five, other is: 2, hello, 4");
    }

    #[test]
    fn test_no_destruct_tuple(){
        assert_eq!(no_destruct_tuple((1, 2, String::from("hello"), 3)), "first is one, other does't matter");
        assert_eq!(no_destruct_tuple((2, 3, String::from("hello"), 2)), "last is two");
